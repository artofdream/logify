...
contains(html, '<label for="iq">Search issues</label>', 'search issues label');
contains(html, '<label for="istate">State</label>', 'state filter label');
contains(html, '<label for="iflag">Flag</label>', 'flag filter label');
contains(html, '<label for="ioverdue">Overdue only</label>', 'overdue filter label');
...
contains(js, "labeledField('New tag', tagInput)", 'New tag label');
